    ...
    <div class="panel-body text-left">
      <form action="{{ url('/event') }}" method="post" role="form">
        ...
        <div class="form-group">
          ...
          <input name="summary" type="text" class="form-control" placeholder="Car Insurance" value="Car Insurance">
        </div>
        <div class="form-group">
          <label for="">Total Due:</label>
          <input name="total" type="text" class="form-control" placeholder="$100.00">
        </div>
        <div class="form-group">
        ...
        <button type="submit" class="btn btn-block btn-success btn-large">Add New Bill Reminder</button>
      </form>
    </div>
  </div>
@endif
